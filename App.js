    ...
    <View style={styles.container}>
      <View>
        ...
        <View style={styles.top}>
          <Text style={styles.topText}>1. 원활한 세모스 사용을 위한 정보기입</Text>
        ...
        <View style={styles.bottom}>
          <View style={styles.inputBox}>
            <Text style={[styles.inputText, isNickname ? styles.inputTrue : nickname.length >= 2 ? styles.inputFalse : null]}>닉네임</Text>
            {isNickname ? (
            ...
            <TextInput
              style={[
                ...
                isNickname ? styles.inputLineTrue : nickname.length >= 2 ? styles.inputLineFalse : null,
              ]}
              maxLength={15}
            ...
            />
            {!isNickname && nickname.length >= 2 ? <Text style={styles.errorMsg}>닉네임에 영어, 띄어쓰기 및 특수문자는 포함할 수 없습니다.</Text> : null}
          </View>
      ...
      <TouchableHighlight
        style={[styles.buttonBox, isNickname && value && checked ? styles.buttonOk : styles.buttonNo]}
        activeOpacity={0.6}
      ...
      >
        <Text style={[styles.buttonText, isNickname && value && checked ? styles.buttonTextOk : styles.buttonTextNo]}>다음 단계로</Text>
      </TouchableHighlight>
    </View>
  );
};
